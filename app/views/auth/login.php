...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-800 via-red-700 to-red-900 font-sans">
  ...
  <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md border border-red-200">
    ...
    <!-- Error Message -->
    <?php if (!empty($error)): ?>
      <div class="bg-red-50 border border-red-400 text-red-700 text-sm p-3 rounded mb-4 text-center">
        <?= $error ?>
      </div>
    <?php endif; ?>
    ...
    <div class="mt-6 text-center">
      <p class="text-sm text-gray-700">
        ...
        <a href="<?= site_url('auth/register'); ?>" class="text-red-600 hover:text-red-500 font-medium">
          Register here
        </a>
      </p>
    </div>
